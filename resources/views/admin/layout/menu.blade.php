                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/theloai/danhsach">Thể loại danh sách</a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-file-movie-o fa-fw"></i>Loại Tin<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/loaitin/danhsach">Danh sách thể loại</a>
                                </li>
                                <li>
